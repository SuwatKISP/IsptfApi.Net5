...
{
    public class PDOMLC_Amend_Amount_ExpDate_Update_Req
    {
...
//param.Add("@AmendNo", pimdomlcpdate.AmendNo);
//param.Add("@DLCRefNo", pimdomlcpdate.DLCRefNo);
...
//param.Add("@DLCNet", pimdomlcpdate.DLCNet);
...
//param.Add("@AmendFlag", pimdomlcpdate.AmendFlag);
//param.Add("@AmendAmt", pimdomlcpdate.AmendAmt);
//param.Add("@AmendPlus", pimdomlcpdate.AmendPlus);
//param.Add("@AmendMinus", pimdomlcpdate.AmendMinus);
//param.Add("@DePlus_Flag", pimdomlcpdate.DePlus_Flag);
...
//param.Add("@AmendAmtDec", pimdomlcpdate.AmendAmtDec);
//param.Add("@AmendAmtInc", pimdomlcpdate.AmendAmtInc);
