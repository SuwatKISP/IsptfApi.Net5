...
namespace ISPTF.API.Controllers.LoginRegis
{
    ...
    public class IMTROpDocregisterController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public IMTROpDocregisterController(ISqlDataAccess db)
        {
            _db = db;
        }
        ...
        public async Task<IEnumerable<Q_GetDocRegisterPagebyModuleRsp>> GetAll(string? LogType, string? CenterID, string? RegDocNo, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            ...
            var results = await _db.LoadData<Q_GetDocRegisterPagebyModuleRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterSelectPageIMTRO",
                        param);
            return results;
        }


        [HttpGet("register/InsGrdInvoice")]
        public async Task<IEnumerable<Q_IMTROInsGrdInvoiceRsp>> GetAllRefLC(string? CustCode)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_IMTROInsGrdInvoiceRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterInsGrdInvoiceIMTRO",
                        param);
            return results;
        }

        [HttpGet("register/GridDetails")]
        public async Task<IEnumerable<Q_IMTROGridDetailsRsp>> GetAllRefIMBC(string? CustCode, string? RegDocNo)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_IMTROGridDetailsRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterGridDetailsIMTRO",
                        param);
            return results;
        }
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Insert([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            try
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTROInsert",
                    param);
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Update([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTROUpdate",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Cancel([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTROCancel",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
