...
namespace ISPTF.API.Controllers.LoginRegis
{
    ...
    public class IMTRpDocregisterController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public IMTRpDocregisterController(ISqlDataAccess db)
        {
            _db = db;
        }
        //[HttpGet("select")]
        ...
        public async Task<IEnumerable<Q_GetDocRegisterPagebyModuleRsp>> GetAll(string? LogType, string? CenterID, string? RegDocNo, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            ...
            var results = await _db.LoadData<Q_GetDocRegisterPagebyModuleRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterSelectPageIMTR",
                        param);
            return results;
        }


        [HttpGet("register/referIMBL")]
        public async Task<IEnumerable<Q_GetDocRegisterReferIMBL_IMTRRsp>> GetAllRefLC(string? CenterID, string? BLNumber, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferIMBL_IMTRRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferIMBLPageIMTR",
                        param);
            return results;
        }

        [HttpGet("register/referIMBC")]
        public async Task<IEnumerable<Q_GetDocRegisterReferIMBC_IMTRRsp>> GetAllRefIMBC(string? CenterID, string? BCNumber, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferIMBC_IMTRRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferIMBCPageIMTR",
                        param);
            return results;
        }

        [HttpGet("register/referDLC")]
        public async Task<IEnumerable<Q_GetDocRegisterReferDLC_IMTRRsp>> GetAllRefDLC(string? CenterID, string? BENumber, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferDLC_IMTRRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferDLCPageIMTR",
                        param);
            return results;
        }
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Insert([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTRInsert",
                    param);
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Update([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTRUpdate",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Cancel([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterIMTRCancel",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        //                storedProcedure: "usp_q_GetDocRegisterIssuedIMTR",
        //                param);
        //    return results;
        //}
