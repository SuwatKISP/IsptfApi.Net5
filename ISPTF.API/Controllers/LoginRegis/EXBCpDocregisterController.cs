...
namespace ISPTF.API.Controllers.LoginRegis
{
    ...
    public class EXBCpDocregisterController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public EXBCpDocregisterController(ISqlDataAccess db)
        {
            _db = db;
        }
        //[HttpGet("select")]
        ...
        public async Task<IEnumerable<Q_GetDocRegisterPagebyModuleRsp>> GetAll(string? LogType, string? CenterID, string? RegDocNo, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            ...
            var results = await _db.LoadData<Q_GetDocRegisterPagebyModuleRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterSelectPageEXBC",
                        param);
            return results;
        }

        [HttpGet("register/referEXBC")]
        public async Task<IEnumerable<Q_GetDocRegisterReferEXBC_EXBCRsp>> GetLCRefAll(string? CenterID, string? EXPORT_BC_NO, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferEXBC_EXBCRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferEXBCPageEXBC",
                        param);
            return results;
        }

        [HttpGet("register/referEXBC/select")]
        public async Task<IEnumerable<Q_GetDocRegisterReferEXBC_EXBC_SelectRsp>> GetLCRefSelAll(string? EXPORT_BC_NO)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferEXBC_EXBC_SelectRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferEXBCPageEXBC_Select",
                        param);
            return results;
        }
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Insert([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXBCInsert",
                    param);
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Update([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXBCUpdate",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Cancel([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXBCCancel",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        //                storedProcedure: "usp_q_GetDocRegisterIssuedEXBC",
        //                param);
        //    return results;
        //}
