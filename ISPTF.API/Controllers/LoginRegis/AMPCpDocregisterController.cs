...
namespace ISPTF.API.Controllers.LoginRegis
{
    ...
    public class AMPCpDocregisterController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public AMPCpDocregisterController(ISqlDataAccess db)
        {
            _db = db;
        }
        //[HttpGet("select")]
        ...
        public async Task<IEnumerable<Q_GetDocRegisterPagebyModuleRsp>> GetAll(string? LogType, string? CenterID, string? RegDocNo, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            ...
            var results = await _db.LoadData<Q_GetDocRegisterPagebyModuleRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterSelectPageAMPC",
                        param);
            return results;
        }

        [HttpGet("register/referPacking")]
        public async Task<IEnumerable<Q_GetDocRegisterReferPacking_AMPCRsp>> GetPCRefAll(string? CenterID, string? PACKING_NO, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferPacking_AMPCRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferPackingPageAMPC",
                        param);
            return results;
        }

        [HttpGet("register/referPacking/select")]
        public async Task<IEnumerable<Q_GetDocRegisterReferPackingCredit_AMPC_SelectRsp>> GetPCRefSelect(string? PACKING_NO)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferPackingCredit_AMPC_SelectRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferPackingPageAMPC_Select",
                        param);
            return results;
        }
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Insert([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterAMPCInsert",
                    param);
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Update([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterAMPCUpdate",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Cancel([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterAMPCCancel",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        //                storedProcedure: "usp_q_GetDocRegisterIssuedAMPC",
        //                param);
        //    return results;
        //}
