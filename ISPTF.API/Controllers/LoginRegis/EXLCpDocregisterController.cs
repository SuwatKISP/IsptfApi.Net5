...
namespace ISPTF.API.Controllers.LoginRegis
{
    ...
    public class EXLCpDocregisterController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public EXLCpDocregisterController(ISqlDataAccess db)
        {
            _db = db;
        }
        //[HttpGet("select")]
        ...
        public async Task<IEnumerable<Q_GetDocRegisterPagebyModuleRsp>> GetAll(string? LogType, string? CenterID, string? RegDocNo, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            ...
            var results = await _db.LoadData<Q_GetDocRegisterPagebyModuleRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterSelectPageEXLC",
                        param);
            return results;
        }

        [HttpGet("register/referEXLC")]
        public async Task<IEnumerable<Q_GetDocRegisterReferEXLC_EXLCRsp>> GetLCRefAll(string? CenterID, string? EXPORT_LC_NO, string? CustCode, string? CustName, string? Page, string? PageSize)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferEXLC_EXLCRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferEXLCPageEXLC",
                        param);
            return results;
        }

        [HttpGet("register/referEXLC/select")]
        public async Task<IEnumerable<Q_GetDocRegisterReferEXLC_EXLC_SelectRsp>> GetLCRefSelAll( string? EXPORT_LC_NO)
        {
            DynamicParameters param = new();
            ...
            var results = await _db.LoadData<Q_GetDocRegisterReferEXLC_EXLC_SelectRsp, dynamic>(
                        storedProcedure: "usp_q_GetDocRegisterReferEXLCPageEXLC_Select",
                        param);
            return results;
        }
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Insert([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXLCInsert",
                    param);
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Update([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXLCUpdate",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        public async Task<ActionResult<List<PDocRegisterInsUpdReq>>> Cancel([FromBody] PDocRegisterInsUpdReq pdocregisterreq)
        {
            ...
            {
                var results = await _db.LoadData<PDocRegister, dynamic>(
                    storedProcedure: "usp_pDocRegisterEXLCCancel",
                    param);
                var resp = param.Get<int>("@Resp");
                if (resp == 1)
                {
        ...
        //                storedProcedure: "usp_q_GetDocRegisterIssuedEXLC",
        //                param);
        //    return results;
        //}
