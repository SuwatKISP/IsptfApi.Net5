...
namespace ISPTF.API.Controllers.Remittance 
{
    ...
    public class RemitRegistInwardSWIFTController : ControllerBase
    {
        private readonly ISqlDataAccess _db;
        public RemitRegistInwardSWIFTController(ISqlDataAccess db)
        {
            _db = db;
        }

        //[HttpGet("editlist")]
        //public async Task<IEnumerable<Q_RegistInwardSWITPageRsp>> GetEditList(string? CenterID, string? Cust_Code, string? CustInfo1, string? Page, string? PageSize)
        //{
        ...
        //    var results = await _db.LoadData<Q_RegistInwardSWITPageRsp, dynamic>(
        //                //storedProcedure: "usp_pRemittanceRegistInwardSWITSelectPage",
        //                storedProcedure: "usp_pRemittance_RegistInwardSWIT_SelectPage",
        //                param);
        //    return results;
        //}
        ...
        //                storedProcedure: "usp_pRemittance_Select",
        //                param);
        //    return results;
        //}

        //[HttpPost("insert")]
        //public async Task<ActionResult<List<RegistInwardSWIT>>> Insert([FromBody] RegistInwardSWIT premittance)
        //{
        ...
        //    param.Add("@SwifInID", premittance.SwifInID);
        ...
        //    {
        //        var results = await _db.LoadData<PRemittance, dynamic>(
        //            storedProcedure: "usp_pRemittanceRegistInwardSWITInsert",
        //            param);
        ...
        //[HttpPost("update")]
        //public async Task<ActionResult<List<RegistInwardSWIT>>> update([FromBody] RegistInwardSWIT premittance)
        //{
        //    DynamicParameters param = new DynamicParameters();
        //    param.Add("@RemRefNo", premittance.RemRefNo);
        //    param.Add("@EventDate", premittance.EventDate);
        ...
        //    {
        //        var results = await _db.LoadData<PRemittance, dynamic>(
        //            storedProcedure: "usp_pRemittanceRegistInwardSWITUpdate",
        //            param);
        //        //var resp = param.Get<int>("@Resp");
        //        var resp = param.Get<string>("@Resp");
        //        if (resp == "1")
        ...
        //        //var resp = param.Get<int>("@Resp");
        //        await _db.SaveData(
        //          storedProcedure: "usp_pRemittanceRegistInwardSWITCancel", param);
