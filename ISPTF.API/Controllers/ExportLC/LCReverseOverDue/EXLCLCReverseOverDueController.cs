...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCLCReverseOverDueController : ControllerBase
    {
        ...
        public EXLCLCReverseOverDueController(ISqlDataAccess db)
        {
            _db = db;
        }

        [HttpGet("list")]
        public async Task<EXLCLCReverseOverDueListResponse> GetAllList(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? USER_ID, string? Page, string? PageSize)
        {
