...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCLCReverseOverDueController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<IEnumerable<Q_EXLCLCReverseOverDueListPageRsp>> GetAllList(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? USER_ID, string? Page, string? PageSize)
        {
