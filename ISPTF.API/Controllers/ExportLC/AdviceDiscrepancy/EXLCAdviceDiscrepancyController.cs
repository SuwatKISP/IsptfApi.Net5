...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCAdviceDiscrepancyController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<ActionResult<EXLCAdviceDiscrepancyListResponse>> List(string? ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? Page, string? PageSize)
        {
