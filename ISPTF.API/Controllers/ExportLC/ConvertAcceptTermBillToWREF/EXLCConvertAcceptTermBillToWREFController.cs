...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCConvertAcceptTermBillToWREFController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<ActionResult<EXLCConvertAcceptTermBillToWREFListResponse>> List(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? Page, string? PageSize)
        {
