...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCPurchasePaymentController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<EXLCPurchasePaymentListResponse> GetAllList(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? USER_ID, string? Page, string? PageSize)
        {
