...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCPurchasePaymentController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<IEnumerable<Q_EXLCPurchasePaymentListPageRsp>> GetAllList(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? USER_ID, string? Page, string? PageSize)
        {
