...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCLCPastDueWREFController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<ActionResult<EXLCLCPastDueWREFListResponse>> GetAllList(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? USER_ID, string? Page, string? PageSize)
        {
