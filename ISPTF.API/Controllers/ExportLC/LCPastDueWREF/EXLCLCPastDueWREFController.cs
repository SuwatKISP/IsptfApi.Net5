...
namespace ISPTF.API.Controllers.ExportLC
{
    ...
    public class EXLCLCPastDueWREFController : ControllerBase
    {
        ...
        [HttpGet("list")]
        public async Task<ActionResult<EXLCLCPastDueWREFListResponse>> List(string? @ListType, string? CenterID, string? EXPORT_LC_NO, string? BENName, string? Page, string? PageSize)
        {
