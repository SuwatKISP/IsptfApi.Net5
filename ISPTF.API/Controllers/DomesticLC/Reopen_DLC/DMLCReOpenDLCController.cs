...
namespace ISPTF.API.Controllers.DomesticLC
{
    ...
    public class DMLCReOpenDLCController : ControllerBase
    {
        ...
        public DMLCReOpenDLCController(ISqlDataAccess db, ISPTFContext context)
        {
            _db = db;
            _context = context;
        }
        ...
        [HttpGet("list")]
        public async Task<ActionResult<ReOpenDLCListPageResponse>> List(string? ListType,string? CenterID, string? @DLCNumber, string? CustCode, string? @CustName, string? Page, string? PageSize)
        {
            ReOpenDLCListPageResponse response = new ReOpenDLCListPageResponse();
            ...
            if (string.IsNullOrEmpty(ListType) || string.IsNullOrEmpty(CenterID) || string.IsNullOrEmpty(Page) || string.IsNullOrEmpty(PageSize))
            {
                ...
                response.Data = new List<Q_ReOpenDLCListPageRsp>();
            ...
            try
            {
                ...
                var results = await _db.LoadData<Q_ReOpenDLCListPageRsp, dynamic>(
                            storedProcedure: "usp_q_DMLC_ReOpenDLCListPage",
                            param);

                response.Code = Constants.RESPONSE_OK;
                response.Message = "Success";
                response.Data = (List<Q_ReOpenDLCListPageRsp>)results;
        ...
        [HttpHead("save/ Use ​api​/DMLCFormIssueDLC​/save LoadLC = REOPEN ")]
        ...
        [HttpHead("release/ Use ​api​/DMLCFormIssueDLC​/release LoadLC = REOPEN ")]
        ...
        [HttpHead("delete/ Use ​api​/DMLCFormIssueDLC​/delete LoadLC = REOPEN ")]
