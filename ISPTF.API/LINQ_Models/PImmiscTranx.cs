...
{
    public partial class PImmiscTranx
    {
        ...
        public string DocCommCcy { get; set; }
        public string DocFbcharge { get; set; }
        public string DocFbinterest { get; set; }
        public string Fbccy { get; set; }
        public string Fbcharge { get; set; }
        public string Fbinterest { get; set; }
        public string CommCcy { get; set; }
        public string CommOther { get; set; }
        public string MarginAmt { get; set; }
        public string CableMail { get; set; }
        ...
        public string DateGenAc { get; set; }
        ...
        public string ChipBank52 { get; set; }
